...
class GameActivity : AppCompatActivity(), OnPlayGame, OnResultGame {
    ...
    private val activeGameBiding: ActivityGameBinding by lazy {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(activeGameBiding.root)

        setSupportActionBar(activeGameBiding.gameVTbIn.gameTb)
    ...
    override fun onShowResult(points: Float) {
        supportFragmentManager.beginTransaction().replace(R.id.gameFl, ResultFragment.newInstance(points)).commit()
    }
}